        ...
        <div class="bg-white shadow-sm dark:bg-gray-900 sm:rounded-lg">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                ...
                <div class="flex justify-between">
                    ...
                    <div class="flex">
                        <x-secondary-button wire:click='print' class="pt-2.5 pb-3 mr-1">
                        ...
                        <x-secondary-button wire:click="$dispatch('openModal', {component: 'modals.import-tecnicos'})" class="pt-2.5 pb-3 mr-3">
