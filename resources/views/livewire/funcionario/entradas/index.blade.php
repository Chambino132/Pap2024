                    ...
                    <div class="bg-white rounded-lg shadow-lg dark:bg-gray-400 overflow-hidden">
                        <table class="w-full table-auto">
                            <thead class="text-white bg-red-500 shadow-lg dark:bg-red-700">
                                ...
                                <tr>
                                    <th wire:click='ordenar("nome")' class="px-4 py-3 flex text-left dark:hover:bg-red-900 hover:bg-red-700 cursor-pointer">Cliente 
                                        @if ($ordena == 'nome')
                                    ...
                                    @endif</th>
                                    <th wire:click='ordenar("data")' class="px-4 py-3 text-left dark:hover:bg-red-900 hover:bg-red-700 cursor-pointer">
                                        <div class="flex">
                                            Data e Hora 
                                            @if ($ordena == 'data')
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-caret-down-fill mt-1 ms-2" viewBox="0 0 16 16">
